...
export function StatCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-xl">
      {/* Background Accent */}
      <div className="absolute right-0 top-0 h-24 w-24 translate-x-8 -translate-y-8 rounded-full bg-emerald-100/40 transition-transform duration-300 group-hover:scale-125" />
      ...
      <div className="relative flex items-center justify-between">
        ...
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-100 transition-all duration-300 group-hover:bg-emerald-600 group-hover:rotate-6">
